...
<body>
  <div class="sidebar">
    <div class="logo-details">
      ...
      <span class="logo_name">OPEN-LAB</span>
    </div>
      <ul class="nav-links">
        <li>
          <a href="#" class="active">
        ...
        <li>
          <a href="#">
            ...
            <span class="links_name">Remote Nodes</span>
          </a>
        </li>
        <li>
          <a href="#">
  ...
  <section class="home-section">
    <nav>
      ...
      <div class="profile-details">
        ...
        <span class="admin_name"><?php echo "Dinusha" ?></span>
      ...
      <div class="overview-boxes">
        <div class="box">
          <div class="right-side">
            <div class="box-topic">Total Logs</div>
            <div class="number"><?php echo $log_count ?></div>
            <div class="indicator">
